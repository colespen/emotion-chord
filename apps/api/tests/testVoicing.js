...
console.log('MIDI Range:', `${Math.min(...em7Chord.voicing)} - ${Math.max(...em7Chord.voicing)}`);
console.log('Lowest note is:', Math.min(...em7Chord.voicing) >= 55 ? '✅ G3 or higher' : '❌ Below G3');
...
console.log('MIDI Range:', `${Math.min(...am11Chord.voicing)} - ${Math.max(...am11Chord.voicing)}`);
console.log('Lowest note is:', Math.min(...am11Chord.voicing) >= 55 ? '✅ G3 or higher' : '❌ Below G3');
...
console.log('MIDI Range:', `${Math.min(...am9Chord.voicing)} - ${Math.max(...am9Chord.voicing)}`);
console.log('Lowest note is:', Math.min(...am9Chord.voicing) >= 55 ? '✅ G3 or higher' : '❌ Below G3');
